...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleProductNotFoundException(ProductNotFoundException productNotFoundException) {
        Map<String, String> errors = new HashMap<>();
        errors.put("error", productNotFoundException.getMessage());

        return new ResponseEntity<>(errors, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(InvalidOrderStatusTransitionException.class)
    public ResponseEntity<Map<String, String>> handleInvalidOrderStatusTransitionException(InvalidOrderStatusTransitionException invalidOrderStatusTransitionException) {
        Map<String, String> errors = new HashMap<>();
        errors.put("error", invalidOrderStatusTransitionException.getMessage());
